...
# 🔧 使用新的 matmul 精度 API（避免混用新旧API）
os.environ.pop('TORCH_ALLOW_TF32_CUBLAS', None)
os.environ.pop('TORCH_ALLOW_TF32_CUDNN', None)
import shutil
...
from pytorch_lightning.loggers import TensorBoardLogger  # ✅ 改成 TensorBoardLogger
...
class Pipeline(LightningModule):
    ...
    def on_save_checkpoint(self, checkpoint):
        ...
        self.transformer.save_lora_adapter(lora_path, adapter_name=self.hparams.adapter_name)
